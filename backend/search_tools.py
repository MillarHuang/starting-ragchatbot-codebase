...
class CourseSearchTool(Tool):
    ...
    def _format_results(self, results: SearchResults) -> str:
        ...
        for doc, meta in zip(results.documents, results.metadata):
            ...
            # Track source for the UI, with a link if available
...
class CourseOutlineTool(Tool):
    """Tool for retrieving structured course outlines from the course catalog"""
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        return {
            ...
            "description": "Get the complete outline of a course: title, course link, and all lesson numbers and titles",
            "input_schema": {
                "type": "object",
                "properties": {
                    "course_name": {
